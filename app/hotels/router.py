...
async def get_hotels() -> list[SHotel]:
    return await HotelDAO.fetch_all()
...
async def get_hotels_by_location_and_time(
    ...
    hotels = await HotelDAO.fetch_all_by_location_and_time(location, date_from, date_to)
    return hotels
...
async def get_hotel_by_id(
    ...
    return await HotelDAO.fetch_one_or_none(id=hotel_id)
